...
function BuildQuery(stringEstab, stringReg)
{
	...
	var cuisines = "&cuisines=" + stringEstab + vegValue;
    var estabs = "&establishment_type=" + stringReg;
   	var cats = "&category=" + mtValue + "," + dmValue;
    var query = baseUrl + cuisines + estabs + cats;
    return query;
}
 ...
 function CollectData()
{
    ...
    dmValue = dineMethod.options[dineMethod.selectedIndex].value;
    ...
    mtValue = mealType.options[mealType.selectedIndex].value;
